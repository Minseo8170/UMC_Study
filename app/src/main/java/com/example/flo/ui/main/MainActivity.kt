...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("songTitle")) {
            Toast.makeText(this, intent.getStringExtra("songTitle"), Toast.LENGTH_SHORT).show()
        }
...
//    fun receiveAlbumData(albumJson: String) {
//        val gson = Gson()
//        val album = gson.fromJson(albumJson, HomeFragment::class.java)
//
//        binding.mainMiniplayerTitleTv.text = album.
//    }
